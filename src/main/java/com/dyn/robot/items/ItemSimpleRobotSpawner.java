...
public class ItemSimpleRobotSpawner extends Item {
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
		...
		SimpleRobotEntity robot = (SimpleRobotEntity) EntityList.createEntityByIDFromName(new ResourceLocation(Reference.MOD_ID, "robot"), worldIn);
		if (robot == null) {
			return EnumActionResult.FAIL;
		}
		robot.setLocationAndAngles(pos.getX() + 0.5, pos.getY() + 1.3,
 				pos.getZ() + 0.5, MathHelper.wrapDegrees(worldIn.rand.nextFloat() * 360.0F), 0.0F);
