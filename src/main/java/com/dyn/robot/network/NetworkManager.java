...
import com.dyn.robot.network.messages.AbstractMessage;
...
import com.dyn.robot.network.messages.PlayCustomSoundMessage;
...
public class NetworkManager {
	...
	public static void registerMessages() {
		...
		NetworkManager.registerMessage(CodeExecutionEndedMessage.class, CodeExecutionEndedMessage.Handler.class,
				Side.CLIENT);
		NetworkManager.registerMessage(PlayCustomSoundMessage.class, PlayCustomSoundMessage.Handler.class, Side.CLIENT);
