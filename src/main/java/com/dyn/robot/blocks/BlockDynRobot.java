...
public class BlockDynRobot extends BlockFalling {
	...
	public BlockDynRobot() {
		super(Material.iron);
		setDefaultState(blockState.getBaseState().withProperty(BlockDynRobot.FACING, EnumFacing.NORTH));
	}
	...
	protected BlockState createBlockState() {
		return new BlockState(this, new IProperty[] { BlockDynRobot.FACING });
	}
	...
	public int getMetaFromState(IBlockState state) {
		return state.getValue(BlockDynRobot.FACING).getIndex();
	}
	...
	public IBlockState getStateFromMeta(int meta) {
		...
		return getDefaultState().withProperty(BlockDynRobot.FACING, enumfacing);
	}
	...
	public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ,
		...
		return getDefaultState().withProperty(BlockDynRobot.FACING, placer.getHorizontalFacing());
	}
