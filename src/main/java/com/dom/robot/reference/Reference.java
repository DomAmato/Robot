package com.dom.robot.reference;
...
public class Reference {
	...
	public static final String SERVER_PROXY_CLASS = "com.dom.robot.proxy.Server";
	public static final String CLIENT_PROXY_CLASS = "com.dom.robot.proxy.Client";
}
